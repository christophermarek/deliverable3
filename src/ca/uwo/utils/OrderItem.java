...
public class OrderItem {
	...
	return pricingStrategy.calculate(this.quantity, this.price);
    }
    
    public void setPricingStrategy(IndividualPricingStrategy pricingStrategy) {
	this.pricingStrategy = pricingStrategy;
    }
    
    public IndividualPricingStrategy getPricingStrategy() {
